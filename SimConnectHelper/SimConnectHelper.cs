...
namespace SimConnectHelper
{
    ...
    public static class SimConnectHelper
    {
        ...
        private static string GetSimVarXMLPath()
        {
            ...
            var file = Directory.GetFiles(Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.UserProfile), "Appdata\\Roaming\\Microsoft Flight Simulator"), "SimConnect.xml", searchOption).FirstOrDefault();
            if (file != null)
